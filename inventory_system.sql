...
INSERT INTO `event_form_history` (`event_form_id`, `event_name`, `event_title`, `event_date`, `event_duration`, `sender_email`, `date_time_ingress`, `date_time_egress`, `claiming_id`, `place`, `location`, `sponsorship_budg`, `amount`, `target_audience`, `number_audience`, `set_up`, `booth_size`, `booth_inclusion`, `number_tables`, `number_chairs`, `speaking_slot`, `speaker_name`, `date_time`, `duration`, `topic`, `technical_team`, `technical_task`, `trainer_needed`, `trainer_task`, `provide_materials`, `created_at`, `request_status`, `processed_at`, `user_id`, `request_mats`) VALUES
(74, 'Test Claiming id', 'Testing', 'September 1-5, 2025', '5 days', 'carlitotagarro27@gmail.com', '2025-09-02 11:26:00', '2025-09-04 11:26:00', 'Ngayon,Bukas at Magpakailanman', 'Hotel', 'Paranaque', '', NULL, '', 0, '', '', '', 0, 0, '', NULL, '0000-00-00 00:00:00', NULL, '', 'No', NULL, 'No', '', 'No', '2025-09-02 11:26:48', 'Declined', '2025-09-02 11:27:00', 17, 0),
(75, 'Test Duration', 'Grabe ba', 'September 1-5, 2025', '5 days', 'carlitotagarro27@gmail.com', '2025-09-02 11:43:00', '2025-09-04 11:43:00', 'Bukas na to boi', 'Hotel', 'Paranaque', 'Sponsorship', 40000, '', 0, '', '', '', 0, 0, '', NULL, '0000-00-00 00:00:00', NULL, '', 'No', NULL, 'No', '', 'No', '2025-09-02 11:47:15', 'Declined', '2025-09-02 11:48:17', 17, 0);
...
--
ALTER TABLE `event_form`
  MODIFY `event_form_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
